        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <a href="mailto:support@resetbiology.com" className="group bg-gradient-to-br from-primary-900/40 to-secondary-900/40 backdrop-blur-md border border-primary-400/30 rounded-2xl p-8 hover:border-primary-400/60 transition-all hover:shadow-2xl hover:shadow-primary-400/20">
              <div className="flex items-start gap-4"><div className="bg-primary-400/20 p-4 rounded-xl group-hover:bg-primary-400/30 transition-colors"><Mail className="w-8 h-8 text-primary-300" /></div><div className="flex-1"><h2 className="text-xl font-bold text-white mb-2">Email Us</h2><p className="text-gray-300 mb-3">Send us a message and we&apos;ll respond within 24 hours. {/* src: LMP §00 */}</p><p className="text-primary-300 font-medium group-hover:text-primary-200 transition-colors">support@resetbiology.com</p></div></div>
            </a>
