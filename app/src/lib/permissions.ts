...
export function isTrialExpired(session: Session | null): boolean {
...
export function getAccessLevel(session: Session | null): AccessLevel {
...
export function canStartTrial(session: Session | null): boolean {
  if (!session?.user) return false
...
export function getRemainingTrialDays(session: Session | null): number | null {
