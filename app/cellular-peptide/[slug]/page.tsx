      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            {/* Video Links */}
            {protocol.videoLinks && protocol.videoLinks.length > 0 && (
              <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/20">
                <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
                  <span className="bg-gradient-to-r from-[#3FBFB5] to-[#72C247] text-white w-10 h-10 rounded-full flex items-center justify-center mr-3 text-lg">
                    3
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {protocol.videoLinks.map((video, idx) => (
                    <a
                      key={idx}
                      href={video.url}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:border-[#3FBFB5]/50 transition-all hover:scale-105"
                    >
                      <div className="flex items-center gap-4">
                        <div className="bg-red-600/90 backdrop-blur-sm rounded-lg p-3 group-hover:scale-110 transition-transform">
                        ...
                        <svg className="w-5 h-5 text-[#3FBFB5] group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/20">
              <h2 className="text-2xl font-bold text-white mb-6 flex items-center">
                <span className="bg-gradient-to-r from-[#3FBFB5] to-[#72C247] text-white w-10 h-10 rounded-full flex items-center justify-center mr-3 text-lg">
                  {protocol.videoLinks && protocol.videoLinks.length > 0 ? '4' : '3'}
                </span>
