...
| Requirement group | Planned phase | Status |
|---|---:|---|
| FND | Pending roadmap | Not started |
| LOG | Pending roadmap | Not started |
| RUN | Pending roadmap | Not started |
| RDY | Pending roadmap | Not started |
| SWAP | Pending roadmap | Not started |
| EVD | Pending roadmap | Not started |
| HAB | Pending roadmap | Not started |
| COACH | Pending roadmap | Not started |
| UIA / TEL | Pending roadmap | Not started |
| SEC / OPS | Pending roadmap | Not started |
