# Requirements: Reset Biology Education & Research Justification

**Defined:** 2026-03-18
**Core Value:** Every protocol and recommendation must be justified by real, verifiable peer-reviewed research

## v1 Requirements

### Peptide Research (PEPT)

- [ ] **PEPT-01**: Education page has research section covering each tracked peptide (BPC-157, TB-500, Semaglutide, Ipamorelin, Epithalon, GHK-Cu, DSIP, MOTS-c, 5-Amino-1MQ) with 2-4 real PubMed studies per peptide
- [ ] **PEPT-02**: Each peptide study includes mechanism of action, clinical findings, and safety profile citations
- [ ] **PEPT-03**: All existing placeholder/fake PMIDs in the Peptide Therapeutics section replaced with real verified citations
- [ ] **PEPT-04**: Cross-reference peptide-exercise synergies (BPC-157/TB-500 for tendon repair, Semaglutide muscle loss risk, Ipamorelin GH for recovery)
...
- [ ] **NBACK-01**: Research on working memory training and fluid intelligence transfer (Jaeggi 2008 + meta-analyses)
- [ ] **NBACK-02**: Research on dose-response relationship and real-world cognitive benefits
- [ ] **NBACK-03**: Cross-references to neuromuscular recruitment (WORK-02), ear training, and mental mastery modules

### Ear Training / Audio (EAR)

- [ ] **EAR-01**: Research on pitch recognition trainability and auditory neuroplasticity
- [ ] **EAR-02**: Research on role of sound processing in cognitive sharpness, mental clarity, and wellbeing
- [ ] **EAR-03**: Connection to spaced repetition research (FSRS system) and music therapy outcomes
- [ ] **EAR-04**: Cross-references to N-Back (dual modality training) and meditation (sound-based practices)

### Daily Accountability (ACCT)

- [ ] **ACCT-01**: Research on science of daily self-monitoring and habit formation
- [ ] **ACCT-02**: Research on accountability partners/systems improving health adherence
- [ ] **ACCT-03**: At least 3 studies on daily check-ins improving behavioral outcomes

### Gamification / Stakes Motivation (GAME)

- [ ] **GAME-01**: Research on loss aversion and commitment devices in health behavior change
- [ ] **GAME-02**: Research on financial stakes (deposit contracts) improving goal completion
- [ ] **GAME-03**: Research on gamification elements (points, streaks, badges) in wellness apps

### Peptide Co-op (COOP)

- [ ] **COOP-01**: Documentation on value of third-party COA testing for peptide purity verification
- [ ] **COOP-02**: Research/authoritative sources on peptide supply chain integrity and direct sourcing benefits
...
### Education Page Quality (QUAL)

- [ ] **QUAL-01**: Every study on the education page has a verified, clickable PubMed or DOI link
- [ ] **QUAL-02**: Zero placeholder or fabricated PMIDs remain on the page
- [ ] **QUAL-03**: Each section has a "Practical Application" note linking to the relevant portal feature
- [ ] **QUAL-04**: Cross-domain connections are explicitly called out in each section (the web of systems)

## Out of Scope

| Feature | Reason |
|---------|--------|
| New portal features | This milestone is research/documentation only |
| Voice Agent integration | Separate milestone |
| Google Drive Vault | Separate milestone |
| Payment/subscription changes | Separate milestone |
| Implementing new exercise protocols | Document research only, don't build new features |
