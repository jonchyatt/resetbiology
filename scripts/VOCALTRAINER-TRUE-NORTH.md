...
- **Mixing Desk as an orb-launched panel** — the full desk (per-stream vol/pan/meters, seek, A/B, tempo, plunk, mic) collapses to a 🎛️ button on the orb and expands to a bottom-sheet; hidden by default so the page is decluttered. First piece of the panel/layout system. *(shipped 2026-06-27)*
