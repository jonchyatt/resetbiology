...
export const PRESETS: Record<string, StarNestPreset> = {
  ...
  // ─── Ported from ethereal-flame-studio ────────────────────────────────────
  normal: {
    key: 'normal', iterations: 15, volsteps: 8,
    formuparam: 420, stepSize: 355, tile: 700,
    brightness: 0.5, darkmatter: 555, distfading: 55, saturation: 77,
    color: [1, 1, 1], center: [1, 0.3, 0.5, 0],
    scroll: [0.1, 0.1, -0.3, 0], rotation: [0, 0, 0, 0.01],
  },
  purple2: {
    key: 'purple2', iterations: 15, volsteps: 8,
    formuparam: 558.7, stepSize: 390, tile: 952.4,
    brightness: 7, darkmatter: 2000, distfading: 37.8, saturation: 76.1,
    color: [0.909, 0.654, 1.0], center: [1, 0.63, 0.8, 0],
    scroll: [0.1, 0.1, -0.3, 0], rotation: [0, 0, 0, 0.01],
  },
  darkWorld2: {
    key: 'darkWorld2', iterations: 15, volsteps: 8,
    formuparam: 484.4, stepSize: 335, tile: 565.85,
    brightness: -3.9, darkmatter: 179.6, distfading: -70, saturation: 55.9,
    color: [0.256, 0.175, 0.581], center: [-0.1, 0.1, -0.3, -3000],
    scroll: [0.1, 0.1, -0.3, 0], rotation: [0, 3, 0, 0.01],
  },
  darkWorld3: {
    key: 'darkWorld3', iterations: 15, volsteps: 8,
    formuparam: 543.6, stepSize: 407.6, tile: 609.4,
    brightness: -20.5, darkmatter: 535.88, distfading: -37.9, saturation: 55.9,
    color: [0.256, 0.175, 0.581], center: [-0.1, 0.1, -0.3, -3000],
    scroll: [0.1, 0.1, -0.3, 0], rotation: [0, 3, 0, 0.01],
  },
  crazyFractal2: {
    key: 'crazyFractal2', iterations: 15, volsteps: 8,
    formuparam: 1114.1, stepSize: 338.5, tile: 905.7,
    brightness: 15.9, darkmatter: 332.47, distfading: 161.1, saturation: 58.29,
    color: [0.069, 0.588, 0.481], center: [1, 0.3, 0.5, 0],
    scroll: [1.3, 1, 0.6, 0.01], rotation: [0, 0, 0, 0.01],
  },
  crazyFractal3: {
    key: 'crazyFractal3', iterations: 15, volsteps: 8,
    formuparam: 907.31, stepSize: 498.1, tile: 593.5,
    brightness: 0.53, darkmatter: 253.8, distfading: 173.3, saturation: 58.29,
    color: [0.088, 0.021, 0.021], center: [-0.1, 0.1, -0.3, -3000],
    scroll: [0.1, 0.1, -0.3, 0.1], rotation: [0, 3, 0, 0.01],
  },
  greenNebula1: {
    key: 'greenNebula1', iterations: 15, volsteps: 8,
    formuparam: 465.2, stepSize: 254.6, tile: 1194.6,
    brightness: 0.1, darkmatter: 181.8, distfading: 147.1, saturation: 135.8,
    color: [0.308, 0.809, 0.149], center: [1, 0.63, 0.8, 0],
    scroll: [0.1, 0.1, -0.3, 0], rotation: [0, 0, 0, 0.01],
  },
  greenNebula2: {
    key: 'greenNebula2', iterations: 15, volsteps: 8,
    formuparam: 603.81, stepSize: 583, tile: 1253,
    brightness: 23.14, darkmatter: 0, distfading: 18.7, saturation: 27.58,
    color: [0.150, 0.478, 0.046], center: [1, 0.63, 0.8, 0],
    scroll: [0.1, 0.1, -0.3, 0], rotation: [0, 0, 0, 0.01],
  },
  hotSuns: {
    key: 'hotSuns', iterations: 15, volsteps: 8,
    formuparam: 591, stepSize: 380.2, tile: 1605,
    brightness: 0.5, darkmatter: 120, distfading: 80, saturation: 77,
    color: [1, 1, 1], center: [1, 0.63, 0.8, 0],
    scroll: [0.1, 0.1, -0.3, 0], rotation: [0, 0, 0, 0.01],
  },
  yellowNebula: {
    key: 'yellowNebula', iterations: 15, volsteps: 8,
    formuparam: 439.7, stepSize: 532.8, tile: 734.1,
    brightness: -9.3, darkmatter: 300, distfading: 29.7, saturation: 48.4,
    color: [0.545, 0.676, 0.174], center: [1, 0.63, 0.8, 0],
    scroll: [0.1, 0.1, -0.3, 0], rotation: [0, 0, 0, 0.01],
  },
  odd: {
    key: 'odd', iterations: 15, volsteps: 10,
    formuparam: 444, stepSize: -300, tile: 850,
    brightness: 0.5, darkmatter: 221.4, distfading: -73.7, saturation: 62,
    color: [1, 1, 1], center: [1, 0.3, 0.5, 0],
    scroll: [0.1, 0.1, -0.3, 0], rotation: [0, 0, 0, 0.01],
  },
  highQuality: {
    key: 'highQuality', iterations: 20, volsteps: 18,
    formuparam: 420, stepSize: 300, tile: 850,
    brightness: 0.5, darkmatter: 40, distfading: 50, saturation: 62,
    color: [1, 1, 1], center: [1, 0.3, 0.5, 0],
    scroll: [1.3, 1, 0.6, 0.01], rotation: [0, 0, 0, 0.01],
  },
  starNestFX: {
    key: 'starNestFX', iterations: 17, volsteps: 20,
    formuparam: 530, stepSize: 130, tile: 700,
    brightness: 2.0, darkmatter: 25, distfading: 68, saturation: 85,
    color: [1, 1, 1], center: [1, 0.3, 0.5, 0],
    scroll: [3, 1, 0.6, 0.01], rotation: [35, 25, 75, 0.1],
  },
  hsvNormal: {
    key: 'hsvNormal', iterations: 15, volsteps: 8,
    formuparam: 420, stepSize: 355, tile: 700,
    brightness: 0.5, darkmatter: 555, distfading: 55, saturation: 77,
    color: [1, 1, 1], center: [1, 0.3, 0.5, 0],
    scroll: [0.1, 0.1, -0.3, 0], rotation: [0, 0, 0, 0.01],
    hueShift: 0.4, hueSpeed: 0.05, postSaturation: 0.23,
  },
  hsvGreenNebula: {
    key: 'hsvGreenNebula', iterations: 15, volsteps: 8,
    formuparam: 465.2, stepSize: 254.6, tile: 1194.6,
    brightness: 0.1, darkmatter: 181.8, distfading: 147.1, saturation: 135.8,
    color: [0.381, 0.831, 0.238], center: [1, 0.63, 0.8, 0],
    scroll: [0.1, 0.1, -0.3, 0], rotation: [0, 0, 0, 0.01],
    hueShift: 0.54, hueSpeed: 0.03, postSaturation: 0,
  },
  hsvDarkWorld2: {
    key: 'hsvDarkWorld2', iterations: 15, volsteps: 8,
    formuparam: 484.4, stepSize: 335, tile: 565.85,
    brightness: -3.9, darkmatter: 179.6, distfading: -70, saturation: 55.9,
    color: [0.255, 0.173, 0.580], center: [-0.1, 0.1, -0.3, -3000],
    scroll: [0.1, 0.1, -0.3, 0], rotation: [0, 3, 0, 0.01],
    hueShift: 0.77, hueSpeed: 0.02, postSaturation: 1.0,
  },
  hsvCrazyFractal: {
    key: 'hsvCrazyFractal', iterations: 15, volsteps: 8,
    formuparam: 998, stepSize: 498.1, tile: 1046,
    brightness: 2.4, darkmatter: 349, distfading: 173.3, saturation: 58.29,
    color: [0.588, 0.069, 0.069], center: [1, 0.3, 0.5, 0],
    scroll: [1.3, 1, 0.6, 0.01], rotation: [0, 0, 0, 0.01],
    hueShift: 0.12, hueSpeed: 0.15, postSaturation: 1.0,
  },
}
