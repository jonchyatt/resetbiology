  ...
  return (
    <div className="relative space-y-8">
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 10% 20%, rgba(149,114,252,0.12), transparent 45%), radial-gradient(circle at 80% 0%, rgba(34,197,94,0.12), transparent 40%)",
        }}
      />
      ...
      <div className="relative z-10 grid gap-6 xl:grid-cols-3">
        <div className="space-y-6 xl:col-span-2">
          <section className="rounded-3xl border border-white/5 bg-slate-950/70 p-6 shadow-2xl shadow-black/30 backdrop-blur">
            ...
            {assignmentsLoading ? (
              ...
              <>
                ...
                {nextSession ? (
                    ...
                    <div className="mt-4 space-y-3">
                      {nextSession.blocks.slice(0, 3).map((block, blockIndex) => (
                        <div
                          ...
                          className="rounded-xl border border-white/5 bg-slate-950/60 px-4 py-3 text-sm text-slate-200"
                        >
                  ...
                  <p className="mt-6 rounded-xl border border-white/10 bg-slate-900/50 p-4 text-sm text-slate-300">
          ...
          <section className="rounded-3xl border border-white/5 bg-slate-950/70 p-6 shadow-2xl shadow-black/30 backdrop-blur">
            ...
            {todaysWorkouts.length === 0 ? (
              <div className="mt-6 rounded-2xl border border-white/10 bg-slate-900/40 p-6 text-center text-slate-300">
              ...
              <div className="mt-6 space-y-4">
                {Object.entries(workoutsByCategory).map(([category, workouts]) => (
                  <div key={category} className="rounded-2xl border border-white/10 bg-slate-900/40 p-4">
                    ...
                    <div className="mt-4 space-y-3">
                      {workouts.map((workout) => (
                        <div key={workout.id} className="rounded-xl border border-white/5 bg-slate-950/40 p-4">
          ...
          <section className="rounded-3xl border border-white/5 bg-slate-950/70 p-6 shadow-2xl shadow-black/30 backdrop-blur">
            ...
            <textarea
              className="mt-4 w-full rounded-2xl border border-white/10 bg-slate-950/40 px-4 py-3 text-sm text-white placeholder:text-slate-500 focus:border-secondary-400 focus:outline-none"
            ...
            <div className="mt-4 space-y-2">
              ...
              {!checkInsLoading &&
                checkIns.slice(0, 4).map((entry) => (
                  <div key={entry.id} className="flex items-center justify-between rounded-xl border border-white/5 bg-slate-900/50 px-3 py-2 text-xs text-slate-300">
                    <div>
      ...
      <section className="relative z-10 rounded-3xl border border-white/5 bg-slate-950/70 p-6 shadow-2xl shadow-black/30 backdrop-blur">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
        ...
        {protocolsLoading ? (
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-3">
            {protocols.map((protocol) => (
              <article key={protocol.id} className="rounded-2xl border border-white/10 bg-slate-900/60 p-5 shadow-lg shadow-black/20">
                <div className="flex items-center justify-between gap-3">
                ...
                {protocol.readinessNotes && (
                  <div className="mt-3 rounded-xl border border-white/5 bg-slate-950/40 px-3 py-2 text-xs text-slate-300">
...
function StatCard({ icon, label, value, subtext }: { icon: ReactNode; label: string; value: ReactNode; subtext: string }) {
  return (
    <article className="rounded-2xl border border-white/5 bg-slate-950/60 p-4 shadow-xl shadow-black/20 backdrop-blur">
      <div className="flex items-center gap-3">
...
function AssignmentBadge({ label, value, accent }: { label: string; value: string; accent: string }) {
  return (
    <div className={classNames("rounded-2xl border border-white/5 px-4 py-3 text-sm text-slate-200", `bg-gradient-to-br ${accent}`)}>
