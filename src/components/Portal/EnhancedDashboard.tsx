...
const fallbackModules: PortalModuleData[] = [
  ...
  { slug: 'voice-training', label: 'Voice Training', href: '/voice-training', icon: 'Music', colorFrom: 'from-fuchsia-600/30', colorTo: 'to-cyan-700/30', borderColor: 'border-fuchsia-400/30', iconColor: 'text-fuchsia-200', enabled: true, order: 11 },
