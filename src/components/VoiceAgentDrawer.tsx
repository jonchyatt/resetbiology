...
import { Mic, Keyboard, X, Battery } from 'lucide-react';
                            ...
                            <>
                                ...
                                <div className="w-full h-32 flex items-center justify-center gap-1 mb-8">
                                    {[...Array(10)].map((_, i) => (
                                        <motion.div
                                            key={i}
                                            animate={{ height: isListening ? [20, 60, 20] : 10 }}
                                ...
                                <div className="text-center space-y-4">
                                    ...
                                    <p className="text-slate-500">I'm ready to help with your biology reset.</p>
                                </div>
                                ...
                                <div className="mt-12 flex gap-6">
                                    <button
                                        ...
                                        className={`p-6 rounded-full transition-all ${isListening ? 'bg-red-500 shadow-red-500/50' : 'bg-teal-600 shadow-teal-600/50'} shadow-lg text-white`}
                                    >
                            ...
                            <div className="w-full h-full flex flex-col">
                                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                                    <div className="bg-slate-100 p-4 rounded-lg rounded-tl-none max-w-[80%]">
                                        ...
                                        <p>I see you switched to text. How can I help you?</p>
                                    </div>
                                </div>
